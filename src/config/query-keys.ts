export const QUERY_KEYS = {
  ...
  admin: {
    ...
    revenue: (filters?: Record<string, any>) => ['admin', 'revenue', filters || {}] as const,
    tenants: (filters?: Record<string, any>) => ['admin', 'tenants', filters || {}] as const,
    tenantDetail: (id: string) => ['admin', 'tenant', id] as const,
