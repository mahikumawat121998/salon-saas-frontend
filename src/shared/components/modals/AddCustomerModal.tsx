...
export function AddCustomerModal({ open, onClose, onSave }: AddCustomerModalProps) {
  return (
    ...
    >
      <DialogTitle sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontWeight: 800, fontSize: '1.05rem', color: 'text.primary' }}>
        Add New Customer
      ...
      <DialogActions sx={{ p: 2, justifyContent: 'space-between' }}>
        ...
        <Button
          ...
          sx={{ backgroundColor: 'primary.main', textTransform: 'none', fontWeight: 800, borderRadius: '10px', px: 3 }}
        >
          Save Customer
        </Button>
      </DialogActions>
