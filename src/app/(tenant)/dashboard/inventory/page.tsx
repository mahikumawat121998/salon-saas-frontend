...
export default function InventoryPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      showToast.success('Product Deleted', 'Product was removed from inventory.');
    ...
    onError: (err: any) => {
      const rawMsg = err?.response?.data?.message || err?.message || 'Failed to delete product';
      const formattedMsg = Array.isArray(rawMsg) ? rawMsg.join(', ') : rawMsg;
      showToast.error('Failed to Delete Product', formattedMsg);
    },
  });
                ...
                <CardContent sx={{ p: 0, '&:last-child': { pb: 0 } }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="h4" sx={{ fontWeight: 800, color: 'text.primary', lineHeight: 1.1, mt: 0.2 }}>
                        256
                      </Typography>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Box
                      sx={{
                        ...
                        height: 48,
                        borderRadius: '14px',
                        backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(239, 68, 68, 0.15)' : '#FEE2E2'),
            ...
            <Grid size={{ xs: 12, lg: 7.5, xl: 8 }}>
              ...
              >
                  ...
                  <Table size="small">
                    <TableHead sx={{ backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.03)' : '#F9FAFB') }}>
                      <TableRow sx={{ '& th': { borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'), py: 1.2 } }}>
                        ...
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Product</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Category</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Brand</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Stock</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Unit Price</TableCell>
                      ...
                      {isInventoryLoading ? (
                        ...
                        return (
                          <TableRow
                            ...
                            sx={{
                              cursor: 'pointer',
                              backgroundColor: (theme) => isSelected ? (theme.palette.mode === 'dark' ? 'rgba(124, 58, 237, 0.2)' : 'rgba(124, 58, 237, 0.03)') : 'transparent',
                          ...
                          >
                            ...
                            {/* Brand */}
                            <TableCell sx={{ fontSize: '0.8125rem', color: 'text.primary', fontWeight: 500, borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.06)' : '1px solid #F1F5F9') }}>
                              {prod.brand}
                            </TableCell>
                            ...
                            {/* Unit Price */}
                            <TableCell sx={{ fontSize: '0.8125rem', fontWeight: 700, color: 'text.primary', borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.06)' : '1px solid #F1F5F9') }}>
                              {prod.price}
                            </TableCell>
                            ...
                            {/* Actions */}
                            <TableCell align="right" sx={{ borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.06)' : '1px solid #F1F5F9') }}>
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Select size="small" defaultValue={10} sx={{ height: 28, fontSize: '0.75rem', borderRadius: '6px', backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.04)' : '#FFFFFF') }}>
              ...
              <Box
                sx={{
                  ...
                  p: 2,
                  borderRadius: '16px',
                  backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(245, 158, 11, 0.15)' : '#FFFBEB'),
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                  ...
                  <Typography variant="body2" sx={{ fontWeight: 700, fontSize: '0.84rem', color: (theme) => (theme.palette.mode === 'dark' ? '#FBBF24' : '#92400E') }}>
                ...
                <Button
                  ...
                  sx={{
                    ...
                    borderColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(245, 158, 11, 0.4)' : '#FDE68A'),
                    ...
                    borderRadius: '8px',
                    '&:hover': {
                      backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.15)' : '#FEF3C7'),
                    },
                  }}
                >
                  View Low Stock
            ...
            <Grid size={{ xs: 12, lg: 4.5, xl: 4 }}>
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ borderLeft: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #E5E7EB') }}>
                    <Typography variant="subtitle2" sx={{ fontWeight: 800, fontSize: '0.9rem', color: 'text.primary' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.4, mb: 3 }}>
                  ...
                  <Box sx={{ mt: 0.5 }}>
                    ...
                    <Typography variant="body2" sx={{ fontSize: '0.8125rem', lineHeight: 1.5, color: 'text.primary' }}>
