...
export default function MainDashboardPage() {
  ...
  const recentActivities = [
    {
      icon: '💳',
      text: 'Emma Watson paid ₹850 for Hair Color',
      time: '10:30 AM',
      bg: '#EFF6FF',
    },
    {
        ...
        <Grid container spacing={3} sx={{ mb: 3.5 }}>
            ...
            <Card sx={{ borderRadius: '20px', border: '1px solid #F3F4F6', p: 3 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                {todaySchedule.map((item, idx) => (
                  ...
                  >
                    {/* Time */}
                    <Typography variant="caption" sx={{ fontWeight: 700, minWidth: 70, color: 'text.secondary' }}>
                      {item.time}
                    </Typography>
          ...
          <Grid size={{ xs: 12, lg: 5, xl: 4 }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              ...
              <Card sx={{ borderRadius: '20px', border: (theme) => theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #F3F4F6', p: 2.5, backgroundColor: (theme) => theme.palette.mode === 'dark' ? theme.palette.background.paper : '#FFFFFF' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                    ...
                    >
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                        ...
                        <Box>
                          ...
                          <Typography variant="caption" sx={{ display: 'flex', alignItems: 'center', gap: 0.5, fontSize: '0.75rem', color: 'text.secondary' }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Button
                          ...
                          sx={{
                            borderRadius: '8px',
                            borderColor: (theme) => theme.palette.mode === 'dark' ? 'rgba(124, 58, 237, 0.5)' : '#7C3AED',
                            color: (theme) => theme.palette.mode === 'dark' ? '#A78BFA' : '#7C3AED',
                            backgroundColor: (theme) => theme.palette.mode === 'dark' ? 'rgba(124, 58, 237, 0.12)' : 'transparent',
                            fontWeight: 700,
                            fontSize: '0.75rem',
                            py: 0.4,
                            px: 1.2,
                            textTransform: 'none',
                            '&:hover': {
                              backgroundColor: (theme) => theme.palette.mode === 'dark' ? 'rgba(124, 58, 237, 0.25)' : 'rgba(124, 58, 237, 0.04)',
                            },
                          }}
                        >
                          Check In
                        ...
                        <IconButton
                          size="small"
                          sx={{
                            border: (theme) => theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.15)' : '1px solid #E5E7EB',
                            color: 'text.secondary',
                          }}
                        >
                          <PhoneCall size={14} color="inherit" />
                        </IconButton>
                      </Box>
                    </Box>
                  ))}
