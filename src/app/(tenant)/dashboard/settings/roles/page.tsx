          ...
          {mainTab === 0 && (
            <Box>
              ...
              <Card sx={{
                ...
                <TableContainer>
                  <Table size="small">
                    <TableHead sx={{ backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.03)' : '#F8FAFC') }}>
                      <TableRow sx={{ '& th': { borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #F3F4F6'), py: 1.2 } }}>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Role Name</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Type</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Description</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Assigned Staff</TableCell>
                        ...
                        >
                            ...
                            <TableCell>
                              <Chip
                                ...
                                size="small"
                                sx={{
                                  backgroundColor: role.type === 'System' ? 'rgba(124, 58, 237, 0.15)' : 'rgba(59, 130, 246, 0.15)',
                                  color: role.type === 'System' ? '#C4B5FD' : '#60A5FA',
                                  fontWeight: 800,
                                  fontSize: '0.6875rem',
                                  height: 20,
                                }}
                            ...
                            <TableCell>
                              <Chip
                                label={role.status}
                                size="small"
                                sx={{ backgroundColor: 'rgba(16, 185, 129, 0.15)', color: '#34D399', fontWeight: 700, fontSize: '0.6875rem', height: 20 }}
                              />
                            </TableCell>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', pt: 2.5, mt: 1, borderTop: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6') }}>
          ...
          {mainTab === 1 && (
            <Card sx={{
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2.5 }}>
                ...
                <Button variant="outlined" startIcon={<Filter size={16} />} sx={{ borderRadius: '12px', borderColor: (t) => t.palette.mode === 'dark' ? 'rgba(255,255,255,0.1)' : '#E5E7EB', color: 'text.primary', fontWeight: 600, fontSize: '0.84rem', py: 0.8, px: 2, textTransform: 'none' }}>
                  Filters
                </Button>
              </Box>
                ...
                <Table size="small">
                  <TableHead>
                    <TableRow sx={{ '& th': { borderBottom: '1px solid #F3F4F6', py: 1.2 } }}>
                      <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Staff Member</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Current Role</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Permissions</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Status</TableCell>
                      <TableCell align="right" sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Actions</TableCell>
                    </TableRow>
                  </TableHead>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        {selectedStaffUser.email} • {selectedStaffUser.roleName}
                      </Typography>
                    </Box>
                  </Box>
                  <IconButton onClick={() => setIsStaffModalOpen(false)} size="small" sx={{ color: 'text.secondary' }}>
                    <X size={18} />
                  </IconButton>
                </DialogTitle>
            ...
            <DialogContent dividers sx={{ border: 'none', px: 3, py: 2 }}>
              ...
              {wizardStep === 1 && (
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                  ...
                  <Box>
                    <Typography variant="caption" sx={{ fontWeight: 700, display: 'block', mb: 0.8, color: 'text.secondary' }}>Role Name *</Typography>
                  ...
                  <Box>
                    <Typography variant="caption" sx={{ fontWeight: 700, display: 'block', mb: 0.8, color: 'text.secondary' }}>Description</Typography>
                  ...
                  <Grid container spacing={2}>
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <Typography variant="caption" sx={{ fontWeight: 700, display: 'block', mb: 0.8, color: 'text.secondary' }}>Role Type</Typography>
                    ...
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <Typography variant="caption" sx={{ fontWeight: 700, display: 'block', mb: 0.8, color: 'text.secondary' }}>Status</Typography>
              ...
              {wizardStep === 2 && (
                <Grid container spacing={2} sx={{ minHeight: 380 }}>
                  ...
                  <Grid size={{ xs: 12, md: 4 }} sx={{ borderRight: (t) => (t.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'), pr: 2 }}>
                    <Typography variant="caption" sx={{ fontWeight: 700, color: 'text.secondary', display: 'block', mb: 1 }}>MODULE FILTERS</Typography>
                        ...
                        return (
                          <Box
                            ...
                            sx={{
                              ...
                              p: 1.2,
                              borderRadius: '10px',
                              backgroundColor: (t) => (t.palette.mode === 'dark' ? (isSel ? 'rgba(124, 58, 237, 0.25)' : 'transparent') : (isSel ? '#F3E8FF' : 'transparent')),
                              color: (t) => (t.palette.mode === 'dark' ? (isSel ? '#A78BFA' : '#94A3B8') : (isSel ? '#7C3AED' : '#374151')),
                              fontWeight: isSel ? 700 : 500,
                              cursor: 'pointer',
                              '&:hover': { backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.05)' : '#F9FAFB') },
                            }}
                          >
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
                              <IconComp size={18} />
                  ...
                  <Grid size={{ xs: 12, md: 8 }} sx={{ pl: 2 }}>
                        ...
                        return (
                          <Box
                            ...
                            sx={{
                              ...
                              p: 1.2,
                              borderRadius: '10px',
                              border: (t) => `1.5px solid ${isChecked ? '#7C3AED' : t.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.08)' : '#F3F4F6'}`,
                              backgroundColor: (t) =>
                                t.palette.mode === 'dark'
                                  ? isChecked
                                    ? 'rgba(124, 58, 237, 0.2)'
                          ...
                          >
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
                              <Checkbox
                                ...
                                sx={{ color: (t) => (t.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.3)' : '#D1D5DB'), '&.Mui-checked': { color: '#7C3AED' } }}
                              />
                              <Box>
                                <Typography variant="subtitle2" sx={{ fontWeight: 700, fontSize: '0.84rem', color: 'text.primary' }}>
                                  {perm.name}
                    ...
                    <Box
                      sx={{
                        ...
                        p: 1.5,
                        borderRadius: '12px',
                        backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(124, 58, 237, 0.15)' : '#F3E8FF'),
                        border: (t) => (t.palette.mode === 'dark' ? '1px solid rgba(124, 58, 237, 0.3)' : '1px solid #E9D5FF'),
                        display: 'flex',
                        alignItems: 'center',
                        gap: 1.5,
                      }}
                    >
                      ...
                      <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.75rem', color: (t) => (t.palette.mode === 'dark' ? '#C084FC' : '#7C3AED') }}>
              ...
              {wizardStep === 3 && (
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                  {/* Role Summary Box */}
                  <Card sx={{ borderRadius: '16px', border: (t) => (t.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'), p: 2.5, backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.04)' : '#FFFFFF') }}>
                  ...
                  <Card sx={{ borderRadius: '16px', border: (t) => (t.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'), p: 2.5, backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.04)' : '#FFFFFF') }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
                      <Typography variant="subtitle2" sx={{ fontWeight: 800, color: 'text.primary' }}>Assigned Permissions ({selectedPermissionIds.length})</Typography>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'wrap', gap: 1, maxHeight: 180, overflowY: 'auto' }}>
                      {permissionsList
                        ...
                        .map((p) => (
                          <Chip key={p.id} label={p.name} size="small" sx={{ backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(124, 58, 237, 0.25)' : '#F3E8FF'), color: (t) => (t.palette.mode === 'dark' ? '#C084FC' : '#7C3AED'), fontWeight: 700, fontSize: '0.72rem' }} />
                        ))}
                    </Box>
                  </Card>
                </Box>
