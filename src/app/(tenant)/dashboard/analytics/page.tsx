...
function RevenueLineChart() {
  ...
  const gridStroke = isDark ? 'rgba(255, 255, 255, 0.08)' : '#F3F4F6';
  ...
  return (
    <Box sx={{ width: '100%', height: 260, position: 'relative', pt: 2, pb: 1 }}>
      <svg width="100%" height="100%" viewBox="0 0 500 200" preserveAspectRatio="none">
        ...
        <line x1="0" y1="0" x2="500" y2="0" stroke={gridStroke} strokeDasharray="4 4" />
        <line x1="0" y1="40" x2="500" y2="40" stroke={gridStroke} strokeDasharray="4 4" />
        <line x1="0" y1="80" x2="500" y2="80" stroke={gridStroke} strokeDasharray="4 4" />
        <line x1="0" y1="120" x2="500" y2="120" stroke={gridStroke} strokeDasharray="4 4" />
        <line x1="0" y1="160" x2="500" y2="160" stroke={gridStroke} strokeDasharray="4 4" />
...
function DonutChart({
  ...
  return (
    <Box sx={{ position: 'relative', width: size, height: size, mx: 'auto' }}>
      ...
      >
        <Typography variant="subtitle1" sx={{ fontWeight: 800, fontSize: '1rem', color: 'text.primary', lineHeight: 1 }}>
          {centerLabel}
        </Typography>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                      ...
                      <Box>
                        ...
                        <Typography variant="h5" sx={{ fontWeight: 800, color: 'text.primary', lineHeight: 1.1, mt: 0.2 }}>
                          ₹3,420
                        </Typography>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                      <Box
                        sx={{
                          ...
                          height: 44,
                          borderRadius: '14px',
                          backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(249, 115, 22, 0.15)' : '#FFF7ED'),
                          color: (theme) => (theme.palette.mode === 'dark' ? '#FB923C' : '#F97316'),
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                        }}
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                      <Box
                        sx={{
                          ...
                          height: 44,
                          borderRadius: '14px',
                          backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(59, 130, 246, 0.15)' : '#EFF6FF'),
            ...
            <Grid size={{ xs: 12, lg: 5.5 }}>
              <Card sx={{
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                  ...
                  <Select size="small" defaultValue="daily" sx={{ borderRadius: '10px', fontSize: '0.78125rem', height: 32, backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.04)' : '#FFFFFF') }}>
            ...
            <Grid size={{ xs: 12, sm: 6, lg: 3.25 }}>
              <Card sx={{
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2.5 }}>
                  ...
                  <Select size="small" defaultValue="this_week" sx={{ borderRadius: '10px', fontSize: '0.78125rem', height: 32, backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.04)' : '#FFFFFF') }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.2, mt: 3 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.8125rem', color: 'text.primary' }}>
          ...
          <Grid container spacing={3}>
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              <Card sx={{
                ...
                <TableContainer sx={{ flexGrow: 1 }}>
                  <Table size="small">
                    <TableHead sx={{ backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.03)' : '#F9FAFB') }}>
                      <TableRow sx={{ '& th': { borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'), py: 1 } }}>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.72rem' }}>Service</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.72rem' }}>Appointments</TableCell>
                        <TableCell align="right" sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.72rem' }}>Revenue</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {[
                        ...
                        <TableRow key={idx} sx={{ '& td': { borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.06)' : '1px solid #F9FAFB'), py: 1.2 } }}>
                          <TableCell>
                ...
                <Box sx={{ textAlign: 'center', pt: 2, borderTop: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6') }}>
                  <Button
                    size="small"
                    color="primary"
              ...
              <Card sx={{
                ...
                <TableContainer sx={{ flexGrow: 1 }}>
                  <Table size="small">
                    <TableHead sx={{ backgroundColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.03)' : '#F9FAFB') }}>
                      <TableRow sx={{ '& th': { borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'), py: 1 } }}>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.72rem' }}>Staff</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.72rem' }}>Appointments</TableCell>
                        <TableCell align="right" sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.72rem' }}>Revenue</TableCell>
                      </TableRow>
                    </TableHead>
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              <Card sx={{
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.2, flexGrow: 1 }}>
                  {[
                    { title: 'Sales Summary Report', time: 'Generated on 27 Jul 2025, 10:30 AM', color: '#7C3AED', bg: 'rgba(124, 58, 237, 0.15)' },
                    { title: 'Appointment Report', time: 'Generated on 27 Jul 2025, 10:30 AM', color: '#10B981', bg: 'rgba(16, 185, 129, 0.15)' },
                    { title: 'Staff Performance Report', time: 'Generated on 27 Jul 2025, 10:30 AM', color: '#F97316', bg: 'rgba(249, 115, 22, 0.15)' },
                    { title: 'Inventory Report', time: 'Generated on 27 Jul 2025, 10:30 AM', color: '#EF4444', bg: 'rgba(239, 68, 68, 0.15)' },
                    { title: 'Customer Report', time: 'Generated on 27 Jul 2025, 10:30 AM', color: '#3B82F6', bg: 'rgba(59, 130, 246, 0.15)' },
                  ].map((report, idx) => (
                    <Box
                      key={idx}
                      sx={{
                    ...
                    >
                      ...
                      <IconButton size="small" sx={{ border: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.12)' : '1px solid #E5E7EB'), borderRadius: '8px', color: 'text.secondary' }}>
                        <Download size={15} />
                      </IconButton>
                    </Box>
                  ))}
                ...
                <Box sx={{ textAlign: 'center', pt: 2, mt: 1, borderTop: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6') }}>
                  <Button
                    size="small"
                    color="primary"
                    endIcon={<ChevronRight size={16} />}
