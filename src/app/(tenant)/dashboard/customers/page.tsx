        ...
        <Box sx={{ width: '100%', maxWidth: '100%', pb: 4 }}>
              ...
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ '& th': { borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'), py: 1.2 } }}>
                    ...
                    <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Last Visit</TableCell>
                    <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Total Visits</TableCell>
                    <TableCell sx={{ fontWeight: 700, color: 'text.secondary', fontSize: '0.75rem' }}>Total Spent</TableCell>
                  ...
                  {isLoading ? (
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell onClick={() => handleOpenDetails(customer)}>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.8 }}>
                              ...
                              {customer.isVip && (
                                <Chip label="VIP" size="small" sx={{ backgroundColor: 'rgba(124, 58, 237, 0.15)', color: '#A78BFA', fontWeight: 800, height: 16, fontSize: '0.6rem' }} />
                              )}
                            </Box>
                          </Box>
                        </TableCell>
                        ...
                        <TableCell sx={{ fontSize: '0.8125rem', color: 'text.primary', fontWeight: 700 }}>
                          {customer.totalVisits || 0}
                        </TableCell>

                        <TableCell sx={{ fontSize: '0.84rem', color: 'text.primary', fontWeight: 800 }}>
                        ...
                        <TableCell>
                          <Chip
                            ...
                            size="small"
                            sx={{
                              backgroundColor: isActive ? 'rgba(16, 185, 129, 0.12)' : (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.08)' : '#F3F4F6'),
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2.5 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.8 }}>
                    ...
                    {selectedCustomer?.isVip && (
                      <Chip
                        ...
                        size="small"
                        sx={{
                          backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(139, 92, 246, 0.2)' : '#F3E8FF'),
              ...
              <Box sx={{ display: 'flex', gap: 1 }}>
                <IconButton
                  size="small"
                  sx={{
                    backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(59, 130, 246, 0.15)' : '#EFF6FF'),
                    color: (t) => (t.palette.mode === 'dark' ? '#60A5FA' : '#3B82F6'),
                    borderRadius: '10px',
                  }}
                >
                  <Phone size={16} />
                ...
                <IconButton
                  ...
                  sx={{
                    ...
                    color: (t) => (t.palette.mode === 'dark' ? '#34D399' : '#10B981'),
                    borderRadius: '10px',
                  }}
                >
                ...
                <IconButton
                  size="small"
                  sx={{
                    backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(139, 92, 246, 0.15)' : '#F3E8FF'),
                    color: (t) => (t.palette.mode === 'dark' ? '#C4B5FD' : '#7C3AED'),
                    borderRadius: '10px',
                  }}
                >
            ...
            <Grid container spacing={2} sx={{ mb: 3 }}>
              ...
              <Grid size={12}>
                <Card
                  sx={{
                    borderRadius: '16px',
                    border: (t) => (t.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #F3F4F6'),
                    p: 2,
                    backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.03)' : '#FFFFFF'),
                    mb: 2,
                  }}
                >
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.2 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 700, color: 'text.primary' }}>{selectedCustomer?.name}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 700, color: 'text.primary' }}>{selectedCustomer?.phone}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Typography variant="caption" color="text.secondary">Date of Birth</Typography>
                      <Typography variant="body2" sx={{ fontWeight: 600, color: 'text.primary' }}>{selectedCustomer?.dob ? new Date(selectedCustomer.dob).toLocaleDateString() : 'N/A'}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Typography variant="caption" color="text.secondary">Gender</Typography>
                      <Typography variant="body2" sx={{ fontWeight: 600, color: 'text.primary' }}>{selectedCustomer?.gender || 'N/A'}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Typography variant="caption" color="text.secondary">Source</Typography>
                      <Typography variant="body2" sx={{ fontWeight: 600, color: 'text.primary' }}>{selectedCustomer?.source}</Typography>
                    </Box>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 700, color: 'text.primary' }}>{selectedCustomer?.totalVisits || 0}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Typography variant="caption" color="text.secondary">Total Spent</Typography>
                      <Typography variant="body2" sx={{ fontWeight: 800, color: 'text.primary' }}>₹{selectedCustomer?.totalSpent || 0}</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Typography variant="caption" color="text.secondary">Customer Since</Typography>
                      <Typography variant="caption" sx={{ fontWeight: 600, color: 'text.primary' }}>{selectedCustomer?.createdAt ? new Date(selectedCustomer.createdAt).toLocaleDateString() : 'N/A'}</Typography>
                    </Box>
                  </Box>
                </Card>
                ...
                >
                  <Typography variant="subtitle2" sx={{ fontWeight: 800, fontSize: '0.875rem', mb: 1, color: 'text.primary' }}>
                    Last Appointment
                  </Typography>
                  ...
                  <Button
                    ...
                    sx={{
                      borderRadius: '8px',
                      color: 'primary.main',
                      borderColor: (t) => (t.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.12)' : '#E5E7EB'),
                      textTransform: 'none',
                      fontWeight: 700,
                    }}
                  >
                ...
                >
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                    ...
                    <Button size="small" sx={{ textTransform: 'none', fontWeight: 700, fontSize: '0.75rem', color: 'primary.main' }}>
                      + Add Note
                    </Button>
                  </Box>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  <Button
                    ...
                    sx={{
                      borderRadius: '10px',
                      color: 'primary.main',
                      borderColor: (t) => (t.palette.mode === 'dark' ? 'rgba(139, 92, 246, 0.4)' : '#E5E7EB'),
                      fontWeight: 700,
                      textTransform: 'none',
                    }}
                  >
                  ...
                  <Button
                    ...
                    sx={{
                      borderRadius: '10px',
                      color: 'error.main',
                      borderColor: (t) => (t.palette.mode === 'dark' ? 'rgba(239, 68, 68, 0.3)' : '#FEE2E2'),
                      fontWeight: 700,
                      textTransform: 'none',
                    }}
                  >
          ...
          >
            ...
            <DialogActions sx={{ p: 2 }}>
              <Button onClick={() => setIsAddModalOpen(false)} sx={{ color: 'text.secondary', textTransform: 'none', fontWeight: 700 }}>Cancel</Button>
              <Button variant="contained" onClick={handleSaveCustomer} disabled={createCustomerMutation.isPending} sx={{ backgroundColor: 'primary.main', textTransform: 'none', fontWeight: 800, borderRadius: '10px', px: 3 }}>
          ...
          >
            ...
            <DialogActions sx={{ p: 2 }}>
              <Button onClick={() => setIsEditModalOpen(false)} sx={{ color: 'text.secondary', textTransform: 'none', fontWeight: 700 }}>Cancel</Button>
              <Button variant="contained" onClick={handleUpdateCustomer} disabled={updateCustomerMutation.isPending} sx={{ backgroundColor: 'primary.main', textTransform: 'none', fontWeight: 800, borderRadius: '10px', px: 3 }}>
            ...
            <DialogContent sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <Box
                sx={{
                  ...
                  height: 56,
                  borderRadius: '50%',
                  backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(239, 68, 68, 0.15)' : '#FEE2E2'),
                  color: '#EF4444',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <Typography variant="h6" sx={{ fontWeight: 800, fontSize: '1.1rem', color: 'text.primary', mb: 1 }}>
                Delete Customer
              </Typography>
              ...
              <Box
                sx={{
                  ...
                  p: 1.8,
                  borderRadius: '12px',
                  backgroundColor: (t) => (t.palette.mode === 'dark' ? 'rgba(239, 68, 68, 0.1)' : '#FEF2F2'),
                  border: (t) => (t.palette.mode === 'dark' ? '1px solid rgba(239, 68, 68, 0.2)' : '1px solid #FEE2E2'),
                  textAlign: 'left',
                  mb: 3,
                }}
              >
                <Typography variant="caption" sx={{ fontWeight: 800, display: 'block', mb: 0.5, color: (t) => (t.palette.mode === 'dark' ? '#FCA5A5' : '#991B1B') }}>
                  Customer Details
                </Typography>
