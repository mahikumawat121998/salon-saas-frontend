    ...
    <AuthGuard>
      <DashboardLayout>
        <Box sx={{ width: '100%', pb: 4 }}>
          ...
          {/* Sub Navigation */}
          <Box sx={{ borderBottom: 1, borderColor: (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'divider'), mb: 4 }}>
            <Tabs
              value={selectedTab}
                ...
                <Table>
                  <TableHead>
                    <TableRow sx={{
                      ...
                      '& th': {
                        borderBottom: (theme) => (theme.palette.mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.1)' : '1px solid #F3F4F6'),
                        py: 2,
                        fontWeight: 700,
                        color: (theme) => (theme.palette.mode === 'dark' ? '#F8FAFC' : '#4B5563'),
                        fontSize: '0.75rem',
                        textTransform: 'uppercase',
                        letterSpacing: '0.05em',
                      },
                    }}>
                      <TableCell sx={{ color: 'text.primary', fontWeight: 800 }}>Service</TableCell>
                      ...
                      <TableCell sx={{ color: 'text.secondary' }}>Eligible Staff</TableCell>
                  ...
                  <TableBody>
                    {isLoadingServices || isLoadingCategories ? (
                      ...
                      >
                          ...
                          <TableCell>
                            <Chip
                              label={service.category?.name || 'Unknown'}
                              size="small"
                              sx={{
                          ...
                          <TableCell>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                              ...
                              <Typography variant="body2" sx={{ fontWeight: 600, color: 'text.primary' }}>{service.durationMinutes} mins</Typography>
                            </Box>
                          </TableCell>
                          <TableCell>
                            <Typography variant="subtitle2" sx={{ fontWeight: 800, color: 'text.primary' }}>₹{service.price}</Typography>
                          </TableCell>
                          <TableCell>
                            ...
                            <Chip
                              ...
                              sx={{
                                backgroundColor: service.status === 'ACTIVE'
                                  ...
                                  : (theme) => (theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.08)' : '#F3F4F6'),
                                color: service.status === 'ACTIVE' ? '#34D399' : 'text.secondary',
                                fontWeight: 700
                              }}
                            />
                          </TableCell>
                          <TableCell align="right">
                            <IconButton size="small" onClick={() => handleOpenEditService(service)} sx={{ color: '#A78BFA' }}><Edit2 size={18} /></IconButton>
                            <IconButton size="small" onClick={() => handleDeleteService(service.id)} sx={{ color: '#F87171' }}><Trash2 size={18} /></IconButton>
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
          ...
          {selectedTab === 1 && (
            <Card sx={{
              ...
              <Box sx={{ p: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography variant="h6" sx={{ fontWeight: 800, color: 'text.primary' }}>Service Categories</Typography>
                    ...
                    {categories.map((cat) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right">
                            <IconButton size="small" onClick={() => handleOpenCategory(cat)}><Edit2 size={18} color="#A78BFA" /></IconButton>
                            <IconButton size="small" onClick={() => handleDeleteCategory(cat.id)}><Trash2 size={18} color="#F87171" /></IconButton>
                          </TableCell>
                        </TableRow>
                      );
                    })}
